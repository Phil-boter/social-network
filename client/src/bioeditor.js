...
export default class BioEditor extends Component {
    ...
    uploadBio() {
        ...
        axios.post("/uploadBio", {bio: this.state.bio})
        .then((res) => {
        ...
        if(!this.state.textareaVisible){
            if (this.props.bio) {
                ...
                return (
                    <div>
                        ...
                        <button className="edit-button" onClick={()=>this.editBio()}>Add your bio now</button>
                    </div>
                );
            }
        } else {
            return (
                <div>
                    ...
                    <button onClick={()=>this.uploadBio()}>Upload</button>

...
export default class Registration extends Component { // default -- import without {}
    constructor() {
        super();
        this.state = {
            error: false,
    ...
    handleChange(e) { // e-- event Object to handle th users input from "name" property of event-object 
            ...
            <div className="input-section">
                <div> 
                    ...
                    <h1 className="registration-headline">Registration</h1>
                        ...
                        <p className="register-link">Already registered? <Link to="/login">Click here!</Link></p>
                </div>  
